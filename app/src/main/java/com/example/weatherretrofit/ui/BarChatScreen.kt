...
fun BarChatScreen(
    ...
    val precipitationViewModel: BarChatViewModel = viewModel()
    ...
    Scaffold(
        ...
        BartChatHost(
            precipitationUiState = precipitationViewModel.precipitation_UiState,
            retryAction = precipitationViewModel::getOneData,
            modifier = Modifier
...
fun BartChatHost(
    retryAction: () -> Unit,
    precipitationUiState: ChartUiState,
    ...
    when (precipitationUiState) {

        is ChartUiState.Loading -> LoadingScreen(modifier = modifier.fillMaxSize())

        is ChartUiState.Success -> BarChatResultScreen(
            dataResponse = precipitationUiState.dataResponse,
            modifier = modifier.fillMaxWidth(),
        )

        is ChartUiState.Error -> ErrorScreen(
